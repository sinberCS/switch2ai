...
- **直接下载**: [switch2ai-0.1.1.zip](./images/switch2ai-0.1.1.zip)
- **版本**: 0.1.1
- **发布日期**: 最新
...
### 快捷键冲突解决
- **自动检测**: 插件在注册快捷键时自动检测冲突
- **用户选择对话框**: 检测到冲突时弹出对话框让用户选择是否替换
- **冲突移除**: 如果用户选择替换，会先移除冲突的快捷键
- **手动检查**: 使用设置中的"检查快捷键冲突"按钮扫描冲突
- **解决方案**: 可在 `设置` → `快捷键` 中重新分配快捷键来解决冲突
